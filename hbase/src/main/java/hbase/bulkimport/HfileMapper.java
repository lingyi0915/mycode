...
public class HfileMapper extends Mapper<LongWritable, Text, ImmutableBytesWritable, Put>{
  private static final Log LOG = LogFactory.getLog(HfileMapper.class.getName());
...
//      job.setInputFormatClass(FileInputFormat.class);
      ...
      LOG.info("inputformat:"+job.getInputFormatClass());
      LOG.info("输入目录:"+args[0]);
      LOG.info("输出目录:"+args[1]);
