...
public abstract class ValueSource {
   ...
   * <p>
   * Get the SortField for this ValueSource.  Uses the {@link #getValues(Map, LeafReaderContext)}
   * to populate the SortField.
   *
   * @param reverse true if this is a reverse sort.
   * @return The {@link SortField} for the ValueSource
   */
  ...
  class ValueSourceSortField extends SortField {
    public ValueSourceSortField(boolean reverse) {
      super(description(), Type.REWRITEABLE, reverse);
    }
  ...
  /**
   * Implement a {@link FieldComparator} that works
