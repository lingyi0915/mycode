...
public class FileProducer implements Runnable{
    ...
    public FileProducer(String filePath , String topic,Boolean isAsync){
        ...
        if(rootDir.isDirectory()){
            ...
            for(String logType:map.keySet()){
                ...
                if (isAsync) {
                    ...
                    fileProducer.send(record, new DemoCallback(startTime, logType, message));
...
class DemoCallback implements Callback {
    ...
    private final FileMessage message;
         ...
         public DemoCallback(long startTime, String key, FileMessage message) {
